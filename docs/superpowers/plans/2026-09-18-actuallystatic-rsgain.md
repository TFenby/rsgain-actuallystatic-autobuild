...
# Ensure readelf is available for staticness checks. Without this guard, checks 1
# and 2 fail OPEN on a base image without binutils: `grep -c NEEDED` yields 0 and
# reads as "no dynamic dependencies".
